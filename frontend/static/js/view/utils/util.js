...
function createProfileImage(userProfileResponseDTO) {
  const imgElement = createElement('img', 'user-image', {}, { 'alt': '', 'draggable': 'false', 'tabindex': '-1' });
...
function chatBoxLastMessageFormatDateTime(dateTime) {
  const now = new Date();
